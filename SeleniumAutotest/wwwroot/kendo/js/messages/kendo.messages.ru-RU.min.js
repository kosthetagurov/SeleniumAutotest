...
!function(e) {
  ...
  !function(e, t) {
      ...
      kendo.ui.Breadcrumb && (kendo.ui.Breadcrumb.prototype.options.messages = e.extend(!0, kendo.ui.Breadcrumb.prototype.options.localization, {
        rootTitle: "Вернуться в корневую папку"
      })),
      ...
      kendo.ui.Filter && (kendo.ui.Filter.prototype.options.messages = e.extend(!0, kendo.ui.Filter.prototype.options.messages, {
          and: "И",
          or: "Или",
          apply: "Применить"
      })),
      kendo.ui.DropDownTree && (kendo.ui.DropDownTree.prototype.options.messages = e.extend(!0, kendo.ui.DropDownTree.prototype.options.messages, {
          clear: "Очистить",
      })),
      kendo.ui.Filter && (kendo.ui.Filter.prototype.options.operators = e.extend(!0, kendo.ui.Filter.prototype.options.operators, {
          date: {
              eq: "равна",
              gte: "после или равна",
              gt: "после",
      ...
      kendo.ui.TreeView && (kendo.ui.TreeView.prototype.options.messages = e.extend(!0, kendo.ui.TreeView.prototype.options.messages, {
          loading: "Загрузка...",
          requestFailed: "Произошла ошибка при загрузке",
